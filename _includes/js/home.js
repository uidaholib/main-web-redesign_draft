...
{%- assign researcher-fields = 'id;last;first;rank;dept;deptid;pub;publoc;publink;pubtype' | split: ';' -%}
    ...
    '<div class="card-body"> <h4 class="card-title"><a href="http://vivo.nkn.uidaho.edu/individual/' + featuredResearcher.id + '" style="font-weight:normal">' + featuredResearcher.first + ' ' + featuredResearcher.last + '</a></h4>' +
    '<p class="card-text">' + featuredResearcher.rank + '<br><a href="http://vivo.nkn.uidaho.edu/individual/' + featuredResearcher.deptid + '" style="font-weight:normal;font-size:18px;">' + featuredResearcher.dept + '</a></p>' + 
